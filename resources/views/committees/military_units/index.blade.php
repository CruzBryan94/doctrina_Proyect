...
@section('title', 'ADMIN UNIDADES MILITARES')

@section('content_header')
    <div class="title-container mb-0">
        <h1 class="dashboard-title">ADMINISTRACIÓN DE UNIDADES MILITARES</h1>
    </div>
...
@section('content')
    ...
    <div class="d-flex justify-content-center mt-0 mb-3">
        <a href="{{ route('militaryUnits.newMilitaryUnit') }}" class="btn btn-info btn-sm shadow-sm px-3 py-1">
            <i class="fas fa-plus-circle"></i> Crear Nueva Unidad Militar
        </a>
    </div>
    <div class="card mt-1">
            ...
            <table id="usersTable" class="table table-bordered table-hover table-sm">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">NOMBRE DE LA UNIDAD</th>
                ...
                <tbody>
                    @foreach ($militaryUnits as $i => $dato)
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <form action="{{ route('militaryUnits.edit', $dato->id) }}" method="POST">
                                    @csrf
